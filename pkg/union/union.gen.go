...
// Union2 is a generic tagged union type that holds a value of the type Tn.
...
// When invokes one of the provided functions depending on the stored variant.
// If the value is of type Tn, calls tn.
...
// As1 returns the value as T1 and a boolean indicating whether the value is indeed T1.
...
// As2 returns the value as T2 and a boolean indicating whether the value is indeed T2.
...
// MarshalJSON implements the `json.Marshaler` interface for Union2.
func (u *Union2[T1, T2]) MarshalJSON() ([]byte, error) {
	switch u.kind {
	case 1:
		return MarshalJSON(u.t1)
	case 2:
		return MarshalJSON(u.t2)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union2.
// It attempts to decode the JSON data into T1 or Tn.
func (u *Union2[T1, T2]) UnmarshalJSON(data []byte) error {
	err1 := UnmarshalJSON(data, &u.t1)
	if err1 == nil {
		u.kind = 1
		return nil
	}
	err2 := UnmarshalJSON(data, &u.t2)
	if err2 == nil {
		u.kind = 2
		return nil
	}
...
// NewUnion2 returns a builder to construct Union2 values using From1 or From2.
func NewUnion2[T1 any, T2 any]() *union2Builder[T1, T2] {
	return &union2Builder[T1, T2]{}
}

// Union3 is a generic tagged union type that holds a value of the type Tn.
...
// As3 returns the value as T3 and a boolean indicating whether the value is indeed T3.
...
// MarshalJSON implements the `json.Marshaler` interface for Union3.
func (u *Union3[T1, T2, T3]) MarshalJSON() ([]byte, error) {
	...
	case 2:
		return MarshalJSON(u.t2)
	case 3:
		return MarshalJSON(u.t3)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union3.
// It attempts to decode the JSON data into T1 or Tn.
...
// NewUnion3 returns a builder to construct Union3 values using From1 or From3.
func NewUnion3[T1 any, T2 any, T3 any]() *union3Builder[T1, T2, T3] {
	return &union3Builder[T1, T2, T3]{}
}

// Union4 is a generic tagged union type that holds a value of the type Tn.
...
// As4 returns the value as T4 and a boolean indicating whether the value is indeed T4.
...
// MarshalJSON implements the `json.Marshaler` interface for Union4.
func (u *Union4[T1, T2, T3, T4]) MarshalJSON() ([]byte, error) {
	...
	case 3:
		return MarshalJSON(u.t3)
	case 4:
		return MarshalJSON(u.t4)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union4.
// It attempts to decode the JSON data into T1 or Tn.
...
// NewUnion4 returns a builder to construct Union4 values using From1 or From4.
func NewUnion4[T1 any, T2 any, T3 any, T4 any]() *union4Builder[T1, T2, T3, T4] {
	return &union4Builder[T1, T2, T3, T4]{}
}

// Union5 is a generic tagged union type that holds a value of the type Tn.
...
// As5 returns the value as T5 and a boolean indicating whether the value is indeed T5.
...
// MarshalJSON implements the `json.Marshaler` interface for Union5.
func (u *Union5[T1, T2, T3, T4, T5]) MarshalJSON() ([]byte, error) {
	...
	case 4:
		return MarshalJSON(u.t4)
	case 5:
		return MarshalJSON(u.t5)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union5.
// It attempts to decode the JSON data into T1 or Tn.
...
// NewUnion5 returns a builder to construct Union5 values using From1 or From5.
func NewUnion5[T1 any, T2 any, T3 any, T4 any, T5 any]() *union5Builder[T1, T2, T3, T4, T5] {
	return &union5Builder[T1, T2, T3, T4, T5]{}
}

// Union6 is a generic tagged union type that holds a value of the type Tn.
...
// As6 returns the value as T6 and a boolean indicating whether the value is indeed T6.
...
// MarshalJSON implements the `json.Marshaler` interface for Union6.
func (u *Union6[T1, T2, T3, T4, T5, T6]) MarshalJSON() ([]byte, error) {
	...
	case 5:
		return MarshalJSON(u.t5)
	case 6:
		return MarshalJSON(u.t6)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union6.
// It attempts to decode the JSON data into T1 or Tn.
...
// NewUnion6 returns a builder to construct Union6 values using From1 or From6.
...
// Union7 is a generic tagged union type that holds a value of the type Tn.
...
// As7 returns the value as T7 and a boolean indicating whether the value is indeed T7.
...
// MarshalJSON implements the `json.Marshaler` interface for Union7.
func (u *Union7[T1, T2, T3, T4, T5, T6, T7]) MarshalJSON() ([]byte, error) {
	...
	case 6:
		return MarshalJSON(u.t6)
	case 7:
		return MarshalJSON(u.t7)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union7.
// It attempts to decode the JSON data into T1 or Tn.
...
// NewUnion7 returns a builder to construct Union7 values using From1 or From7.
...
// Union8 is a generic tagged union type that holds a value of the type Tn.
...
// As8 returns the value as T8 and a boolean indicating whether the value is indeed T8.
...
// MarshalJSON implements the `json.Marshaler` interface for Union8.
func (u *Union8[T1, T2, T3, T4, T5, T6, T7, T8]) MarshalJSON() ([]byte, error) {
	...
	case 7:
		return MarshalJSON(u.t7)
	case 8:
		return MarshalJSON(u.t8)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union8.
// It attempts to decode the JSON data into T1 or Tn.
...
// NewUnion8 returns a builder to construct Union8 values using From1 or From8.
...
// Union9 is a generic tagged union type that holds a value of the type Tn.
...
// As9 returns the value as T9 and a boolean indicating whether the value is indeed T9.
...
// MarshalJSON implements the `json.Marshaler` interface for Union9.
func (u *Union9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) MarshalJSON() ([]byte, error) {
	...
	case 8:
		return MarshalJSON(u.t8)
	case 9:
		return MarshalJSON(u.t9)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union9.
// It attempts to decode the JSON data into T1 or Tn.
...
// NewUnion9 returns a builder to construct Union9 values using From1 or From9.
...
// Union10 is a generic tagged union type that holds a value of the type Tn.
...
// As10 returns the value as T10 and a boolean indicating whether the value is indeed T10.
...
// MarshalJSON implements the `json.Marshaler` interface for Union10.
func (u *Union10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10]) MarshalJSON() ([]byte, error) {
	...
	case 9:
		return MarshalJSON(u.t9)
	case 10:
		return MarshalJSON(u.t10)
	default:
		panic("unreachable")
	}
}

// UnmarshalJSON implements the `json.Unmarshaler` interface for Union10.
// It attempts to decode the JSON data into T1 or Tn.
func (u *Union10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10]) UnmarshalJSON(data []byte) error {
	...
	err10 := UnmarshalJSON(data, &u.t10)
	if err10 == nil {
		u.kind = 10
		return nil
	}
...
// NewUnion10 returns a builder to construct Union10 values using From1 or From10.
